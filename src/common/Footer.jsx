                ...
                <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-12">
                    ...
                    <div className="space-y-6">
                        ...
                        <div className="flex gap-4 pt-2">
                            {/* Google Reviews */}
                            <a
                                href="https://share.google/IeNtiy2bGsxmRoOBF"
                                target="_blank"
                            ...
                            >
                                <svg className="w-5 h-5 fill-current" viewBox="0 0 24 24">
                                    <path d="M21.35 11.1h-9.17v2.73h6.51c-.33 3.81-3.5 5.44-6.5 5.44C8.36 19.27 5 16.25 5 12c0-4.1 3.2-7.27 7.2-7.27c3.09 0 4.9 1.97 4.9 1.97L19 4.72C19 4.72 16.56 2 12.1 2C6.42 2 2.03 6.8 2.03 12c0 5.05 4.13 10 10.22 10c5.35 0 9.25-3.67 9.25-9.09c0-.61-.06-1.1-.17-1.81z" />
                                </svg>
                            </a>

                            {/* Facebook */}
                            <a
                                href="https://www.facebook.com/people/Ace-Migration/61586901928842/#"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-orange-500 hover:text-white transition-all duration-300 group"
                                title="Facebook"
                            ...
                            {/* LinkedIn */}
                            <a
                                href="https://www.linkedin.com/in/ace-migration-5387ab3a5/?utm_source=share_via&utm_content=profile&utm_medium=member_ios"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-orange-500 hover:text-white transition-all duration-300 group"
                                title="LinkedIn"
                            ...
                            {/* Instagram */}
                            <a
                                href="https://www.instagram.com/ace.migration"
                                target="_blank"
                                rel="noopener noreferrer"
                                className="w-10 h-10 rounded-full bg-gray-800 flex items-center justify-center hover:bg-orange-500 hover:text-white transition-all duration-300 group"
                                title="Instagram"
                        ...
                        <ul className="space-y-4">
                            <li className="flex items-start gap-4 text-gray-400">
                                ...
                                <div>
                                    ...
                                    <a
                                        href="https://www.google.com/maps/dir/24.5863628,73.7046022/516,+Amritshree,+Ace+Migration+%26+Consultation+Services,+Ashok+Nagar+Main+Rd,+near+Jain+Mandir,+Udaipur,+Rajasthan+313001/@24.5864485,73.7027559,17z/data=!3m1!4b1!4m9!4m8!1m1!4e1!1m5!1m1!1s0x3967e5110dee3d87:0x6e6eef51a5c54c2e!2m2!1d73.7049764!2d24.5864921?entry=ttu&g_ep=EgoyMDI2MDExMy4wIKXMDSoASAFQAw%3D%3D"
                                        target="_blank"
                                        rel="noopener noreferrer"
                                        className="hover:text-orange-500 transition"
                                    >
                                        516, 5th Floor, Amritshree, Ashok Nagar Road, Udaipur, Rajasthan, 313001
                                    </a>
                                </div>
                            </li>
                            ...
                            <li className="flex items-start gap-4 text-gray-400">
                                ...
                                <div>
                                    ...
                                    <a
                                        href="mailto:acemigrate.udp@gmail.com"
                                        className="hover:text-orange-500 transition"
                                    >
                                        acemigrate.udp@gmail.com
                                    </a>
                                </div>
                            </li>
