            ...
            <section className="relative bg-gray-900 py-24 md:py-32 overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10 text-center">
                    ...
                    <p className="text-lg md:text-xl text-red-100 max-w-2xl mx-auto leading-relaxed">
                        Everything you need to secure your study permit and launch your Canadian academic experience.
                    </p>
                </div>
            </section>
            ...
            <section className="py-20 bg-gray-50">
                <div className="container mx-auto px-4">
                    ...
                    <div className="max-w-6xl mx-auto mb-20">
                        <h2 className="text-3xl font-bold text-gray-900 mb-10 text-center">Authorization Steps</h2>
                        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-6">
                            <div className="bg-white p-6 rounded-xl shadow-md border-t-4 border-red-600 hover:-translate-y-1 transition-transform">
                                ...
                                <h3 className="text-xl font-bold text-gray-900 mb-2">Obtain Acceptance</h3>
                                <p className="text-gray-600 text-sm">Receive formal admission confirmation from an approved DLI institution.</p>
                            </div>
                            <div className="bg-white p-6 rounded-xl shadow-md border-t-4 border-gray-800 hover:-translate-y-1 transition-transform">
                                ...
                                <h3 className="text-xl font-bold text-gray-900 mb-2">Compile Records</h3>
                                <p className="text-gray-600 text-sm">Assemble current passport, health documentation, background checks, and educational records.</p>
                            </div>
                            <div className="bg-white p-6 rounded-xl shadow-md border-t-4 border-red-600 hover:-translate-y-1 transition-transform">
                                <div className="text-4xl font-bold text-red-100 mb-4">03</div>
                                <h3 className="text-xl font-bold text-gray-900 mb-2">Demonstrate Finances</h3>
                                <p className="text-gray-600 text-sm">Arrange GIC (Guaranteed Investment Certificate) as financial capability evidence.</p>
                            </div>
                            <div className="bg-white p-6 rounded-xl shadow-md border-t-4 border-gray-800 hover:-translate-y-1 transition-transform">
                                <div className="text-4xl font-bold text-gray-200 mb-4">04</div>
                                <h3 className="text-xl font-bold text-gray-900 mb-2">Lodge Request</h3>
                                <p className="text-gray-600 text-sm">File complete study permit application. Anticipate approximately 8 weeks assessment period.</p>
                            </div>
                        </div>
                    </div>
                        ...
                        <div className="bg-white rounded-2xl shadow-lg p-8 border border-gray-100">
                            ...
                            <ul className="space-y-4">
                                {[
                                    ...
                                    "Educational Credentials & Records",
                                    "English Proficiency Certificate",
                                    "Personal Motivation Letter",
                                    "GIC Transfer Confirmation"
                                ].map((item, i) => (
                        ...
                        <div className="bg-gray-900 rounded-2xl shadow-lg p-8 text-white relative overflow-hidden">
                            ...
                            <div className="space-y-6 relative z-10">
                                <div className="bg-white/5 p-4 rounded-lg border border-white/10">
                                    <h4 className="font-bold text-red-300 mb-1">Investment Certificate (GIC)</h4>
                                    <p className="text-sm text-gray-300 mb-2">Annual living expense verification instrument.</p>
                                    <div className="text-2xl font-bold">CAD $10,200</div>
                                </div>

                                <div className="space-y-3 text-sm text-gray-300">
                                    <p><strong className="text-white">Setup:</strong> Establish account through Scotia Bank or comparable authorized institution.</p>
                                    <p><strong className="text-white">Payment:</strong> Transfer $10,200 (comprising $10k principal plus $200 administrative costs).</p>
                                    <p><strong className="text-white">Upon Landing:</strong> Create domestic account for monthly fund distribution.</p>
                                </div>

                                <div className="pt-4 border-t border-white/10">
                                    <p className="text-xs text-gray-400">
                                        * GIC requirement validates adequate resources for initial settlement expenses.
                                    </p>
                                </div>
                            </div>
                        </div>
                    ...
                    <div className="bg-white border-2 border-red-100 rounded-3xl p-10 md:p-16 text-center shadow-xl">
                        <h3 className="text-3xl font-bold text-gray-900 mb-6">Require Application Assistance?</h3>
                        <p className="text-gray-600 text-lg mb-8 max-w-2xl mx-auto">
                            Our qualified advisors provide comprehensive support through SPP procedures, GIC arrangements, and permit submissions to optimize approval chances.
                        </p>
