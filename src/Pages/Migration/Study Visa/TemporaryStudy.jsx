            ...
            <section className="relative bg-gray-900 py-24 md:py-32 overflow-hidden">
                ...
                <div className="container mx-auto px-4 relative z-10 text-center">
                    ...
                    <p className="text-lg md:text-xl text-gray-300 max-w-2xl mx-auto leading-relaxed">
                        Your Path to Australian Opportunities. A visa tailored for recent international graduates to live, study, and work in Australia.
                    </p>
                </div>
            </section>
                ...
                <div className="container mx-auto px-4">
                    ...
                    <div className="max-w-4xl mx-auto bg-white rounded-2xl shadow-xl p-8 md:p-12 mb-16 border-t-4 border-orange-500 relative overflow-hidden">
                        ...
                        <p className="text-gray-600 leading-relaxed text-lg relative z-10">
                            This visa is tailored for recent international graduates with skills that Australia seeks.
                            It offers a temporary stay with the flexibility to live, study, and work in Australia,
                            providing a bridge from student life to professional career opportunities.
                        </p>
                    </div>
                    ...
                    <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 max-w-7xl mx-auto">
                        ...
                        <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-8 border border-gray-100 group">
                            ...
                            <ul className="space-y-3 text-gray-600">
                                <li className="flex items-start gap-2"><span className="text-orange-500 mt-1">•</span>Stay for 18 months (up to 5 years for Hong Kong passport holders)</li>
                                <li className="flex items-start gap-2"><span className="text-orange-500 mt-1">•</span>Multiple entries allowed</li>
                                <li className="flex items-start gap-2"><span className="text-orange-500 mt-1">•</span>Family inclusion permitted</li>
                            </ul>
                        </div>
                        ...
                        <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-8 border border-gray-100 group">
                            ...
                            <ul className="space-y-3 text-gray-600">
                                ...
                                <li className="flex items-start gap-2"><span className="text-green-500 mt-1">✓</span>Qualification on skilled occupation list</li>
                                <li className="flex items-start gap-2"><span className="text-green-500 mt-1">✓</span>Skills suitable for listed occupation</li>
                                <li className="flex items-start gap-2"><span className="text-green-500 mt-1">✓</span>Meet health & character requirements</li>
                            </ul>
                        </div>
                        ...
                        <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-8 border border-gray-100 group">
                            ...
                            <h3 className="text-xl font-bold text-gray-900 mb-4">Duration & Travel</h3>
                            <ul className="space-y-3 text-gray-600">
                                <li className="flex items-start gap-2">Typically 18 months duration</li>
                                <li className="flex items-start gap-2">Unlimited travel in & out of Australia</li>
                                <li className="flex items-start gap-2">Multiple entries allowed</li>
                            </ul>
                        </div>
                        ...
                        <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-8 border border-gray-100 group">
                            ...
                            <ul className="space-y-3 text-gray-600">
                                <li className="flex items-start gap-2">Family inclusion permitted</li>
                                <li className="flex items-start gap-2">Partners & children can be added</li>
                                <li className="flex items-start gap-2 text-sm text-gray-500">Mandatory health insurance (Condition 8501) required.</li>
                            </ul>
                        </div>
                        ...
                        <div className="bg-white rounded-xl shadow-md hover:shadow-xl transition-all duration-300 p-8 border border-gray-100 group">
                            ...
                            <ul className="space-y-3 text-gray-600">
                                <li className="flex items-start gap-2">Apply within Australia</li>
                                <li className="flex items-start gap-2">Processing time: 5-6 months</li>
                                <li className="flex items-start gap-2 text-sm text-gray-500">Ensure all documentation is complete to avoid delays.</li>
                            </ul>
                        </div>
                    ...
                    <div className="mt-20 text-center">
                        <div className="bg-gradient-to-r from-gray-900 to-blue-900 rounded-3xl p-10 md:p-16 relative overflow-hidden shadow-2xl max-w-5xl mx-auto">
                            ...
                            <h3 className="text-3xl md:text-4xl font-bold text-white mb-6 relative z-10">Embark on your journey to success! 🚀</h3>
                            <p className="text-blue-200 text-lg mb-8 max-w-2xl mx-auto relative z-10">
                                Ready to apply for the Graduate Work Stream (Subclass 485)? Our registered migration agents are here to guide you through every step.
                            </p>
